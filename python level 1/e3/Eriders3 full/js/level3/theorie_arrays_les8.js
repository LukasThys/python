...
function toonArray(){
  ...
  // ------>  IS de stopconditie wel juist??????    < ------------
	for(let i = 0; i<10; i+=1){
      // ... bewaar het element in variable fruitOmOpHetSchermTeSchrijven
    //  ------>   gaan we altijd 'banaan' zeggen?  Of halen we het juiste element uit de array??????  <----------------------
...
function toonWillekeurigElement(){
  ...
  //  ------------>  klopt die berekening van de random index wel?????    <---------------
	let willekeurigeIndex = Math.floor(Math.random()*10);
  ...
  //  ---------> vinden we altijd een willekeurige banaan?   Of gaan we iets willekeurig uit de array pakken????   <----------------
	fruitOmOpHetSchermTeSchrijven = "banaan";
