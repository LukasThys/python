...
//  link de knop met id "knopWillekeurig" aan functie toonWillekeurigElement
document.getElementById("knopWillekeurig").addEventListener("click", toonWillekeurigElement);
//  link de knop met id "knopSorteer" aan functie sorteerArray
document.getElementById("knopSorteer").addEventListener("click", sorteerArray);
